...
def good_students(students):
    ...
    return f"Ученики {shortNames[:-2]} в этом семестре учаться на отлично!"

students = (('Кожевников Марк Евгеньевич', 16, 1.0, 'Чухоз'),
            ("Федулов Дмитрий Игоревич", 17, 2.3, "Новосибирск"),
            ("Капустин Кирилл Максимович", 17, 4.4, "Новосибирск"),
            ("Кондратенко Дмитрий Алекстандрович", 17, 3.9, "Чик"),
            ("Рылякова Дарья Максимовна", 17, 1.52, "Чулым"),
            ("Бобровская Анастасия Дмитриевна ", 17, 2.5, "Томск"),
            ("Трубин Данил Владимирович", 17, 5.0, "Обь"))
